...
const STATIC_OG_PAGES = [
  ...
  // ── Social Hero Profiles (Hindi /hi/ variants) ──
  { path: 'social-hero/hi/anshu-gupta',              title: "अंशु गुप्ता — Goonj के संस्थापक | ProfileBizz",                       desc: "अंशु गुप्ता ने शहरों के फेंके कपड़ों को करोड़ों लोगों के लिए सम्मान में बदला — Goonj ने कपड़े को राहत और ग्रामीण विकास का ज़रिया बनाया।", image: 'https://profilebizz.com/anshu-gupta.png' },
  { path: 'social-hero/hi/sonam-wangchuk',           title: "सोनम वांगचुक — लद्दाख को बदलने वाले इनोवेटर | ProfileBizz",          desc: "सोनम वांगचुक ने लद्दाख के पानी संकट के लिए Ice Stupa बनाया और हिमालयी बच्चों की शिक्षा में क्रांति लाई।", image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&q=80' },
  { path: 'social-hero/hi/bindeshwar-pathak',        title: "डॉ. बिंदेश्वर पाठक — Sulabh International के संस्थापक | ProfileBizz", desc: "डॉ. पाठक के Sulabh International ने 50 करोड़ भारतीयों को स्वच्छ शौचालय दिया — एक स्वच्छता क्रांति जिसने मैला ढोने वालों को सम्मान दिलाया।", image: 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=1200&q=80' },
  { path: 'social-hero/hi/ela-bhatt',                title: "इला भट्ट — SEWA की संस्थापक | ProfileBizz",                           desc: "इला भट्ट के Self-Employed Women's Association ने 25 लाख असंगठित महिला कामगारों को सशक्त किया — एक श्रम आंदोलन जो वैश्विक मॉडल बना।", image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=1200&q=80' },
  { path: 'social-hero/hi/arunachalam-muruganantham',title: "अरुणाचलम मुरुगनंतम — भारत के पैडमैन | ProfileBizz",                  desc: "तमिलनाडु के एक स्कूल ड्रॉपआउट ने सस्ते सैनिटरी पैड बनाए और ग्रामीण महिलाओं के लिए मासिक धर्म स्वास्थ्य को सुलभ बनाया।", image: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=1200&q=80' },
  { path: 'social-hero/hi/rajendra-singh',           title: "राजेंद्र सिंह — भारत के 'वाटरमैन' | ProfileBizz",                    desc: "राजेंद्र सिंह ने राजस्थान में पाँच नदियाँ पुनर्जीवित कीं और 1,000+ गाँवों में जोहड़ से पानी वापस लाया — मैग्सेसे पुरस्कार विजेता।", image: 'https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=1200&q=80' },
