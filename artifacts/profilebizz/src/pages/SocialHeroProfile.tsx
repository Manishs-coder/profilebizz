...
const FEATURED_HEROES = [
  {
    ...
    name: 'Anshu Gupta',
    title: 'Founder, Goonj',
    tag: 'Dignity Through Cloth',
    coverPhoto: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=1600&q=80',
    location: 'Delhi',
    impact: '5 Million+ Lives',
    founded: '1999',
    category: 'NGO Founders',
    pullQuote: '"Cloth is a basic need, not charity. Every discarded shirt in an urban home is a resource waiting to reach a village."',
    story: [
      'In 1999, Anshu Gupta quit his job as a journalist to start Goonj — an organisation that treats urban waste (old clothes, utensils, furniture) as a resource for rural India. What began as collecting discarded material from Delhi apartments has grown into one of India\'s most innovative humanitarian organisations.',
      'Goonj\'s model is radical in its simplicity: urban India\'s surplus is rural India\'s need. But Anshu refused to make it charity — instead, Goonj exchanges material aid for community labour (building roads, cleaning rivers, digging ponds). The exchange preserves dignity. No one receives anything without contributing.',
      'Today, Goonj operates across 25+ states, has processed over 10,000 tonnes of urban material, and reaches 5 million people annually. Anshu has received the Ramon Magsaysay Award — Asia\'s Nobel Prize — for this work.',
    ],
    achievements: [
      { label: 'Lives Touched', value: '5 Million+' },
      { label: 'States Covered', value: '25+' },
      { label: 'Material Processed', value: '10,000+ Tonnes' },
      { label: 'Years of Impact', value: '25' },
    ],
    recognition: ['Ramon Magsaysay Award 2015', 'Ashoka Fellow', 'CNN-IBN Indian of the Year', 'NDTV Social Entrepreneur'],
    philosophy: 'Material is dignity. Exchange is empowerment. Every piece of cloth that travels from a city to a village carries with it the idea that the person receiving it is not a beggar but a partner.',
  },
  {
    slug: 'sonam-wangchuk',
    name: 'Sonam Wangchuk',
