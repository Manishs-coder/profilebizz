...
const FEATURED_HEROES = [
  ...
  },
  {
    ...
    pullQuote: '"If the work is theirs and the labor is theirs, then the right to be recognized as workers belongs to them too."',
    story: [
      ...
      'In November 2022, at the age of eighty-nine, Ela Bhatt passed away. The world mourned her loss, but the seed she had planted had grown into a massive tree with deep, unbreakable roots. Following her passing, SEWA did not slow down; instead, it expanded with renewed vigor.',
      'Today, Ela Bhatt\'s vision stands as a global beacon of hope. SEWA now unites over two and a half million self-employed women across more than eighteen Indian states. SEWA members have evolved beyond traditional tailoring and street vending — today, they operate on e-commerce platforms, run digital banking services, and utilize solar pumps for climate-smart agriculture. Following the SEWA blueprint, organizations have been established in Nepal, Afghanistan, Pakistan, Sri Lanka, and Bangladesh. The ILO has recognized SEWA\'s cooperative structure as a benchmark model for informal sector workers worldwide. She proved to the world that true women\'s empowerment does not come from speeches — it begins when a woman holds her own hard-earned money and controls her own bank account.',
    ],
    achievements: [
    ...
    philosophy: 'True women\'s empowerment does not come from speeches. It begins when a woman holds her own hard-earned money and controls her own bank account.',
  },
  {
  ...
  },
  {
    ...
    founded: '1985',
    category: 'Rural Heroes',
    pullQuote: '"Son, give us medicine later. Give us water first. If water comes back, half our illnesses will disappear on their own." — Mangu Lal Meena, village elder',
    story: [
  ...
  },
  {
    ...
    title: 'The Mountain Man of Gehlaur',
    tag: 'The Lone Hero of an Unstoppable Journey',
    photo: '/dashrath-manjhi.webp',
    coverPhoto: '/dashrath-manjhi.webp',
    location: 'Gehlaur, Gaya, Bihar',
    impact: '55 km → 15 km · Thousands of Lives Saved',
    founded: '1960',
    category: 'Rural Heroes',
    pullQuote: '"Passion so fierce that even the mountain was forced to yield a path."',
    story: [
      ...
      'Lacking money to purchase tools, he sold his few goats to buy a basic hammer and chisel, embarking on his daunting task entirely alone. The 22-year journey from 1960 to 1982 was filled with agonizing struggles. Initially, villagers and relatives mocked him as \'crazy\' and abandoned him socially. Without a steady income, he and his family faced severe starvation. In the beginning, he worked as a laborer in the morning and broke rocks in the afternoon, but eventually he dedicated his entire life solely to carving the mountain.',
      'Harsh weather conditions could not shake his spirit. Through scorching Bihar summers, freezing winters, and heavy monsoons, he never missed a day of work. Flying stone chips left him bruised and bleeding, and his hands developed deep blisters, yet he would simply wrap his wounds in cloth and pick up his hammer again. When a severe drought struck the region and most villagers migrated to cities for survival, Manjhi stayed behind alone in the desolate Gehlaur valley, continuing his relentless effort. As the mountain gradually yielded, the mocking turned into deep respect, and locals eventually started offering him food and support.',
      ...
      'On August 17, 2007, Dashrath Manjhi passed away at AIIMS, New Delhi due to gallbladder cancer, and the Bihar Government accorded him a full State Funeral. Today, the dirt path he carved has been converted into a fully paved tar road officially named "Dashrath Manjhi Path" or "Gehlaur Ghati". A grand memorial, a statue, a hospital, and the "Dashrath Manjhi Dwar" stand in Gehlaur village, where his historic hammer and chisel are preserved as symbols of his unparalleled human spirit. Dashrath Manjhi\'s life stands as a timeless reminder that when human determination is absolute, a single individual can move mountains and rewrite history.',
    ],
    achievements: [
    ...
    philosophy: 'When I started hammering the hill, people called me a lunatic. But I had made a vow to my wife. What the government couldn\'t do in decades, love and grief pushed one man to do alone — with nothing but a hammer, a chisel, and 22 years of will.',
  },
];
...
const HEROES_HI: Record<string, Partial<typeof FEATURED_HEROES[0]>> = {
  ...
  'rajendra-singh': {
    name: 'राजेन्द्र सिंह',
    title: 'वॉटरमैन ऑफ इंडिया',
    tag: 'जब दवा छूटी और हाथ में कुदाल आई',
    location: 'अलवर, राजस्थान',
    impact: '12,000 गाँव, 11 नदियाँ',
    category: 'ग्रामीण हीरो',
    pullQuote: '"बेटा, हमें बीमारियों की दवा बाद में देना, पहले हमें पानी दो। पानी आ गया, तो हमारी आधी बीमारियाँ अपने आप खत्म हो जाएँगी।" — मंगू लाल मीणा, बुजुर्ग ग्रामीण',
    story: [
      'एक समय था जब राजस्थान के अलवर जिले का भीकमपुरा गाँव धूल, कड़कती धूप और भयंकर सूखे की मार झेल रहा था। कुएँ सूखकर पाताल जा चुके थे, खेत बंजर पड़े थे और प्यास से तंग आकर गाँव के युवा अपनी मिट्टी छोड़कर शहरों की ओर पलायन कर रहे थे। चारों तरफ निराशा का एक खामोश सन्नाटा पसरा हुआ था।',
      'इसी दौरान, आयुर्वेदिक चिकित्सा की पढ़ाई पूरी करके एक नौजवान गाँव में कदम रखता है। उनका नाम था राजेन्द्र सिंह। वे गाँव के लोगों का इलाज करने और शिक्षा की अलख जगाने का इरादा लेकर आए थे। गाँव पहुँचकर जब उन्होंने लोगों की नब्ज टटोलनी शुरू की, तो गाँव के एक बुजुर्ग मंगू लाल मीणा ने उनसे एक ऐसी बात कही जिसने राजेन्द्र जी की सोच सदा के लिए बदल दी: "बेटा, हमें बीमारियों की दवा बाद में देना, पहले हमें पानी दो। यहाँ बीमारी से ज्यादा लोग पानी की कमी और भूख से मर रहे हैं। पानी आ गया, तो हमारी आधी बीमारियाँ अपने आप खत्म हो जाएँगी।"',
      'बुजुर्ग की यह बात राजेन्द्र सिंह के दिल में सीधे उतर गई। उन्होंने समझ लिया कि इस सूखी धरती का असली इलाज दवाइयाँ नहीं, बल्कि जल संचयन है। राजेन्द्र सिंह ने बिना देर किए अपना स्टेथोस्कोप और दवाइयों की थैली एक तरफ रख दी और अपने हाथों में कुदाल और फावड़ा उठा लिया। उन्होंने बुजुर्गों से "जोहड़" (मिट्टी के पारंपरिक छोटे बाँध) बनाने की पुरानी और भूली-बिसरी कला सीखी।',
      'शुरुआत आसान नहीं थी। अकेले कुदाल चलाने वाले इस नौजवान का पहले तो लोगों ने मज़ाक उड़ाया। लेकिन राजेन्द्र सिंह की अटूट लगन देखकर धीरे-धीरे गाँव के लोग, महिलाएँ और युवा भी उनके साथ जुड़ते गए। सबने मिलकर दिन-रात एक कर दिया और गाँव की ढलान पर पहला जोहड़ बनाकर तैयार किया।',
      'जब बारिश का मौसम आया, तो वो चमत्कार हुआ जिसका इंतजार पूरे इलाके को बरसों से था। बारिश का बहता पानी उस जोहड़ में थमने लगा। सूखी मिट्टी ने पानी सोखा और देखते ही देखते कुएँ फिर से पानी से लबालब भर गए। इस सफलता ने आसपास के दर्जनों गाँवों में उम्मीद की नई किरण जगा दी। एक के बाद एक, हजारों जोहड़ बनाए गए। अरवारी और रुपारेल जैसी नदियाँ, जो पूरी तरह सूख चुकी थीं, एक बार फिर कल-कल करके बहने लगीं।',
    ...
    philosophy: 'पानी कोई इंजीनियरों के प्रबंधन की चीज़ नहीं है — यह एक ऐसा रिश्ता है जिसे समुदाय को निभाना होता है। लोगों को अपने पानी का मालिक बना दो, वे खुद अपनी नदियाँ वापस ले आएँगे।',
  },
  'dashrath-manjhi': {
    name: 'दशरथ मांझी',
    title: 'गेहलौर का माउंटेन मैन',
    tag: 'अकेले सफर का महा-नायक',
    location: 'गेहलौर, गया, बिहार',
    impact: '55 किमी → 15 किमी · हज़ारों जीवन बचाए',
    category: 'ग्रामीण हीरो',
    pullQuote: '"जुनून ऐसा कि पहाड़ भी रास्ता देने पर मजबूर हो गया।"',
    story: [
      'बिहार के गया जिले के पास स्थित गेहलौर गाँव में जन्मे दशरथ मांझी एक बेहद गरीब परिवार से थे। गाँव के ठीक सामने एक विशाल और कठिन पहाड़ था जो पूरे गाँव को नजदीकी शहर, बाजार और अस्पताल से पूरी तरह अलग कर देता था। किसी भी मेडिकल इमरजेंसी के समय गाँव वालों को 55 किलोमीटर का लंबा और दुर्गम रास्ता तय करना पड़ता था, जिससे समय पर अस्पताल पहुँचना लगभग असंभव था।',
      'एक दिन उनकी पत्नी फागुनी देवी पहाड़ के उस पार उनके लिए खाना ले जा रही थीं, तभी पहाड़ पर पैर फिसलने के कारण वे गंभीर रूप से घायल हो गईं। पहाड़ का लंबा चक्कर काटकर अस्पताल ले जाने में काफी देर हो गई और सही समय पर इलाज न मिलने की वजह से उनकी मृत्यु हो गई। इस दुख और आक्रोश ने मांझी को तोड़ा नहीं, बल्कि एक ज़िद्दी और दृढ़ संकल्प में बदल दिया। उन्होंने ठान लिया कि जिस पहाड़ ने उनकी पत्नी की जान ली है, वे उसे काटकर ऐसा रास्ता बनाएंगे ताकि गाँव के किसी और को अपनी जान न गंवानी पड़े।',
      'पहाड़ काटने के लिए औज़ार खरीदने का भी उनके पास पैसा नहीं था, इसलिए उन्होंने अपनी कुछ बकरियाँ बेचकर छैनी और हथौड़ा खरीदा और अकेले ही उस विशाल पहाड़ को तोड़ना शुरू कर दिया। उन 22 सालों (1960 से 1982) का सफर बेहद दर्दनाक और कठिन रहा। शुरुआत में गाँव वालों और रिश्तेदारों ने उन्हें \'पागल\' समझकर जमकर मज़ाक उड़ाया और सामाजिक रूप से अकेला छोड़ दिया। उनके पास कोई नियमित कमाई नहीं थी, जिससे उन्हें और उनके परिवार को कई बार भूखे पेट भी सोना पड़ा। शुरुआत में वे सुबह-शाम मजदूरी करते और दोपहर में पहाड़ काटते, लेकिन बाद में उन्होंने अपना पूरा जीवन केवल पहाड़ काटने में ही समर्पित कर दिया।',
      'मौसम की मार भी उनके हौसले को नहीं तोड़ सकी। बिहार की भीषण गर्मी, कड़ाके की ठंड और भारी बारिश के बावजूद उन्होंने एक भी दिन काम नहीं रोका। पत्थर के टुकड़े छिटकने से वे कई बार लहूलुहान हुए और हाथों में गहरे छाले पड़ गए, लेकिन घाव पर कपड़ा बाँधकर वे फिर छैनी-हथौड़ा उठा लेते थे। जब इलाके में भयानक सूखा पड़ा और गाँव के ज़्यादातर लोग पलायन कर शहर चले गए, तब भी दशरथ मांझी बंजर गेहलौर घाटी में अकेले डटे रहे। जैसे-जैसे पहाड़ कटने लगा, लोगों का मज़ाक सम्मान में बदलने लगा और कुछ ग्रामीणों ने उन्हें खाना-पानी देना भी शुरू कर दिया।',
      'आखिरकार 22 साल की अटूट मेहनत के बाद 1982 में उन्होंने अकेले ही 360 फुट लंबा, 30 फुट चौड़ा और 25 फुट गहरा रास्ता पहाड़ के बीच से काटकर बना दिया। इससे अत्रि और वजीरगंज के बीच की दूरी 55 किलोमीटर से घटकर सिर्फ 15 किलोमीटर रह गई और हजारों लोगों की जान बची। सरकार ने उनके सम्मान में डाक टिकट (Postage Stamp) जारी किया और उनकी जिंदगी पर बॉलीवुड फिल्म \'मांझी - द माउंटेन मैन\' भी बनी।',
      '17 अगस्त 2007 को एम्स, नई दिल्ली में गॉलब्लाडर कैंसर के कारण उनका निधन हो गया, जिसके बाद बिहार सरकार ने उनका अंतिम संस्कार पूर्ण राजकीय सम्मान के साथ किया। आज उनके बनाए रास्ते को सरकार ने पूरी तरह से पक्की सड़क में बदल दिया है, जिसे आधिकारिक रूप से \'दशरथ मांझी पथ\' या \'गेहलौर घाटी\' कहा जाता है। गेहलौर गाँव में उनकी याद में एक भव्य स्मारक, विशाल प्रतिमा, अस्पताल और \'दशरथ मांझी द्वार\' बनाया गया है, जहाँ उनकी ऐतिहासिक छैनी और हथौड़े को भी सुरक्षित रखा गया है। दशरथ मांझी का यह जीवन हमें सिखाता है कि अगर इंसान का संकल्प दृढ़ हो, तो बिना संसाधनों के भी अकेला व्यक्ति सबसे बड़ी रुकावट को खत्म करके इतिहास रच सकता है।',
    ],
    achievements: [
    ...
    philosophy: 'जब मैंने पहाड़ तोड़ना शुरू किया तो लोगों ने मुझे पागल कहा। लेकिन मैंने अपनी पत्नी को वचन दिया था। जो काम सरकार दशकों में नहीं कर पाई, वो एक आदमी ने प्रेम और दर्द की ताकत से कर दिखाया — सिर्फ एक हथौड़े, एक छैनी और 22 साल की जिद से।',
  },
  'ela-bhatt': {
    name: 'इला भट्ट',
    title: 'श्रम अधिकार कार्यकर्ता और SEWA की संस्थापक',
    tag: 'शांत क्रांतिकारी',
    location: 'अहमदाबाद, गुजरात',
    impact: '25 लाख महिलाएं, 18+ राज्य',
    category: 'महिला सशक्तिकरण',
    pullQuote: '"अगर काम उनका है, मेहनत उनकी है, तो मज़दूर होने का हक़ भी उनका है।"',
    story: [
      ...
      'यह कहानी सिर्फ शांताबेन की नहीं थी। कपड़ा सिलने वाली, बीड़ी बनाने वाली और कचरा बीनने वाली लाखों अनौपचारिक महिला श्रमिकों की यही दास्तान थी। देश उन्हें "मज़दूर" मानने को भी तैयार नहीं था, क्योंकि उनके पास किसी कंपनी का अपॉइंटमेंट लेटर नहीं था। लेकिन एक महिला थी जो हर दिन इन महिलाओं के संघर्ष को करीब से देख रही थी — इला भट्ट।',
      'पेशे से वकील और गांधीवादी विचारों से प्रेरित इला भट्ट चाहती तो आराम की ज़िंदगी जी सकती थीं। लेकिन जब उन्होंने इन महिलाओं की बेबसी देखी, तो उन्होंने तय किया कि वे इनकी आवाज़ बनेंगी। जब इला जी ने इन मज़दूर महिलाओं को एक ट्रेड यूनियन में बदलने की बात कही, तो श्रम नेताओं और अधिकारियों ने उनका मज़ाक उड़ाया। इला जी का जवाब साफ़ और निडर था: "अगर काम उनका है, मेहनत उनकी है, तो मज़दूर होने का हक़ भी उनका है।"',
      'सत्तर के दशक की शुरुआत में इला भट्ट ने SEWA (Self-Employed Women\'s Association) की नींव रखी। जब ये गरीब महिलाएँ सामान्य बैंकों में खाता खुलवाने गईं, तो बैंकों ने मना कर दिया क्योंकि वे दस्तखत नहीं कर सकती थीं। इस रुकावट ने इला जी को एक और ऐतिहासिक कदम उठाने पर मजबूर किया — उन्होंने "SEWA सहकारी बैंक" की शुरुआत की। इतिहास में पहली बार, अंगूठा लगाने वाली अनपढ़ महिलाएँ खुद अपनी बचत की मालिक बनीं और साहूकारों के चंगुल से आज़ादी पाई।',
      'इला जी के इस मॉडल ने दुनिया का ध्यान खींचा। उन्हें रेमन मैगसेसे, पद्म भूषण, राइट लाइवलीहुड अवॉर्ड और इंदिरा गांधी शांति पुरस्कार से सम्मानित किया गया। नेल्सन मंडेला ने जब "द एल्डर्स" (The Elders) बनाया तो इला भट्ट को उसका संस्थापक सदस्य चुना गया।',
      'नवंबर 2022 में नवासी वर्ष की आयु में इला भट्ट जी का निधन हो गया। पूरा देश और दुनिया शोकाकुल थी, लेकिन जो बीज उन्होंने बोया था, वह एक ऐसा विशाल वटवृक्ष बन चुका था जिसकी जड़ें बहुत गहरी थीं। इला भट्ट जी के जाने के बाद भी SEWA रुकी नहीं, बल्कि और तेजी से आगे बढ़ी।',
      'आज भारत के 18 से ज़्यादा राज्यों में 25 लाख से अधिक महिलाएँ SEWA से जुड़ी हैं। SEWA की महिलाएँ ई-कॉमर्स प्लेटफ़ॉर्म पर सामान बेच रही हैं, डिजिटल बैंकिंग चला रही हैं, और खेतों में सोलर पंप का इस्तेमाल कर रही हैं। SEWA के मॉडल पर नेपाल, अफगानिस्तान, पाकिस्तान, श्रीलंका और बांग्लादेश में भी महिला संगठन बने हैं। संयुक्त राष्ट्र की संस्था ILO ने SEWA के मॉडल को दुनिया के असंगठित क्षेत्र के मज़दूरों के लिए "आदर्श मॉडल" स्वीकार किया है। इला भट्ट ने साबित किया कि महिला सशक्तिकरण भाषणों से नहीं — जब महिला के हाथ में उसका अपना कमाया पैसा और बैंक खाता होता है, तब आता है।',
    ],
    achievements: [
    ...
    philosophy: 'महिला सशक्तिकरण भाषणों से नहीं आता। यह तब आता है जब महिला के हाथ में उसका अपना कमाया पैसा और बैंक खाता होता है।',
  },
};
