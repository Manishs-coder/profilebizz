...
const INDUSTRIES: Record<string, IndustryData> = {
  ...
  /* ═══════════ REAL ESTATE ═══════════ */
  'real-estate': {
    name: 'Real Estate', tagline: 'Building the New India', icon: '🏘️', tag: 'Infra',
    coverPhoto: 'https://images.unsplash.com/photo-1582407947304-fd86f028f716?w=1600&q=80',
    marketSize: '₹13 Lakh Crore', gdpShare: '7.3% of GDP', employment: '70 Million', growthRate: '14% CAGR',
    oneLiner: 'India\'s real estate sector is the second-largest employer in the country and the backbone of the construction economy — building homes for 1.4 billion people across 640,000 villages and 8,000 cities.',
    overview: {
      body: [
        'India\'s real estate sector encompasses residential housing, commercial offices, retail malls, logistics & warehousing, and hospitality. At ₹13 Lakh Crore in market size, it is the second-largest sector in India after agriculture — and the second-largest employer, providing livelihoods to 70 million people directly and indirectly.',
        'The sector is experiencing a structural boom driven by urbanisation (India adds 10 million urban residents annually), rising incomes (median household income doubling every 10 years), favourable demographics (360 million millennials entering prime home-buying age by 2030), and RERA — the regulatory reform that transformed consumer trust in real estate.',
      ],
      stats: [
        { label: 'Market Size', value: '₹13L Crore' },
        { label: 'GDP Contribution', value: '7.3%' },
        { label: 'Employment', value: '70 Million' },
        { label: 'Urban Housing Shortage', value: '18.7 Million Units' },
        { label: 'Office Stock', value: '800 Mn sq ft' },
        { label: 'Growth Rate', value: '14% CAGR' },
      ],
    },
    history: {
      timeline: [
        { year: '1956', event: 'DDA (Delhi Development Authority) formed — first organised urban housing agency in India' },
        { year: '1970s', event: 'Maharashtra MHADA, Gujarat GHB — state housing boards build mass urban housing' },
        { year: '1991', event: 'Liberalisation — private developers enter large-scale residential projects' },
        { year: '1994', event: 'Narasimha Rao reforms allow FDI in real estate — international capital begins flowing in' },
        { year: '2005', event: 'FDI in real estate formally allowed. DLF, Unitech, Emaar mega-projects begin.' },
        { year: '2008', event: 'Global financial crisis — Indian real estate first major correction. Unsold inventory crisis begins.' },
        { year: '2016', event: 'RERA (Real Estate Regulation and Development Act) — game-changing consumer protection law' },
        { year: '2019', event: 'IBC (Insolvency and Bankruptcy Code) applied to real estate — stuck projects begin getting resolved' },
        { year: '2023', event: 'Post-COVID housing boom — record residential sales across top 8 cities' },
      ],
      body: [
        'Indian real estate\'s modern history has two eras: pre-RERA (Wild West — builder-dominant, consumer-exploitative) and post-RERA (regulated, transparent, consumer-protected). RERA 2016 was the single most consequential reform in the sector\'s history.',
        'The pre-RERA era saw widespread project delays, fund diversion, and fraud. Buyers paid 100% upfront and waited 5–10 years for possession. RERA mandated escrow accounts, project registration, and timely delivery — forcing consolidation among developers and rebuilding buyer trust.',
      ],
    },
    structure: {
      steps: [
        { title: 'Land Acquisition', desc: 'Developers acquire land from landowners, government land banks, or through joint development agreements (JDAs). Land cost is 20–40% of total project cost in major metros.' },
        { title: 'Approvals & Clearances', desc: 'RERA registration, municipal building permits, environmental clearances, fire NOCs. The approval process takes 18–36 months in most cities — India\'s biggest real estate bottleneck.' },
        { title: 'Construction', desc: 'Civil, MEP (mechanical, electrical, plumbing), and finishing by contractors. Labour-intensive — real estate is India\'s second-largest employer of construction workers.' },
        { title: 'Sales & Marketing', desc: 'Pre-launch bookings, channel partner networks, digital marketing, and property exhibitions. Post-RERA, developers collect maximum 10% before project registration.' },
        { title: 'Handover & Society Formation', desc: 'Possession, registration, and formation of Residents\' Welfare Association (RWA). Post-RERA, defect liability period of 5 years for structural defects.' },
      ],
      body: [
        'India\'s real estate sector is highly fragmented — the top 10 developers control less than 15% of residential supply. RERA is driving consolidation: smaller, non-compliant developers are being squeezed out, while branded developers with execution track records command premium pricing.',
      ],
    },
    keyPlayers: [
      { name: 'DLF', type: 'Listed', revenue: '₹6,200 Cr', note: 'India\'s largest listed developer. 180 million sq ft delivered. DLF Cyber City commercial portfolio.' },
      { name: 'Godrej Properties', type: 'Listed', revenue: '₹3,500 Cr', note: 'Fastest-growing listed developer. Pan-India presence. FY24 bookings: ₹22,500 Crore.' },
      { name: 'Prestige Estates', type: 'Listed', revenue: '₹7,000 Cr', note: 'Dominant in Bengaluru. Expanding to Mumbai, Delhi, Hyderabad.' },
      { name: 'Lodha (Macrotech)', type: 'Listed', revenue: '₹14,000 Cr', note: 'India\'s largest residential developer by revenue. World One, Palava township.' },
      { name: 'Brigade Group', type: 'Listed', revenue: '₹2,800 Cr', note: 'South India specialist. Offices, retail, hospitality alongside residential.' },
    ],
    market: {
      pullQuote: '"India will need 10 crore new homes by 2030. Every one of them represents a family\'s life savings, a child\'s school, and a community\'s future. Real estate is not just an industry — it is the physical fabric of Indian society."',
      body: [
        'India\'s residential market sold a record 4.7 lakh units across top 8 cities in FY24 — the highest since 2013. Premium housing (₹1 Crore+) now accounts for 30% of sales, up from 15% in 2019. This premiumisation reflects India\'s growing affluent class and the COVID-era shift to larger, better-quality homes.',
        'The commercial office market is equally strong — India absorbed 60 million sq ft of office space in FY24, driven by GCC (Global Capability Centres) expansion. Indian cities are becoming the preferred location for Fortune 500 R&D and technology centres.',
      ],
      segments: [
        { name: 'Residential', share: '65%' },
        { name: 'Commercial Offices', share: '20%' },
        { name: 'Retail & Hospitality', share: '8%' },
        { name: 'Warehousing & Industrial', share: '7%' },
      ],
    },
    challenges: [
      { title: 'Affordable Housing Gap', body: 'India\'s housing shortage of 18.7 million units is almost entirely in the affordable segment (below ₹45 lakh). Developers have no economic incentive to build affordable units in prime cities — land costs alone exceed ₹45 lakh per unit. The affordable housing mission requires a fundamentally different public-private model.' },
      { title: 'Approval Timelines', body: 'Getting building permits and environmental clearances takes 18–36 months in most Indian cities. This approval delay increases project costs (interest burden on land), reduces housing supply, and keeps prices elevated. Single-window approval systems exist on paper but not in practice in most states.' },
      { title: 'Stuck Legacy Projects', body: 'An estimated 4.5 lakh units — worth ₹4.5 lakh crore — are "stuck" across India: construction stalled, buyers paid, developers insolvent. SWAMIH fund and IBC are resolving these gradually, but 300,000+ families are still waiting for homes they paid for years ago.' },
    ],
    opportunity: {
      areas: [
        { title: 'Affordable Housing (PMAY)', desc: 'PM Awas Yojana target: 2 crore homes by 2024. Massive opportunity for developers who can crack the sub-₹30 lakh construction cost in peripheral city locations.' },
        { title: 'Warehousing & Logistics', desc: 'E-commerce and supply chain modernisation driving demand for Grade A warehousing. India needs 100 million sq ft of new warehousing by 2025.' },
        { title: 'Data Centres', desc: 'Hyperscaler demand (AWS, Google, Microsoft) is creating a new real estate asset class. India data centre capacity to triple to 10 GW by 2030.' },
        { title: 'Plotted Development & Integrated Townships', desc: 'Post-COVID demand surge for plotted development (buy land, build own home) and integrated townships (self-contained communities). Huge opportunity outside top-8 cities.' },
      ],
      body: [],
    },
    policy: {
      schemes: [
        { name: 'RERA 2016', desc: 'Real Estate Regulatory Authority. Project registration, escrow accounts, timely delivery mandates. Consumer protection revolution.' },
        { name: 'PMAY (PM Awas Yojana)', desc: '₹2 Lakh Crore scheme. Credit-linked subsidy for affordable housing. 2 crore homes target.' },
        { name: 'SWAMIH Fund', desc: '₹15,530 Crore stress fund for stuck affordable/mid-income housing projects. 50,000+ units to be completed.' },
        { name: 'National Monetisation Pipeline', desc: 'Government monetising public assets (land, buildings) to fund infrastructure. Creates significant real estate investment opportunities.' },
      ],
      body: [
        'RERA has been the most transformative real estate policy in India\'s history — shifting the sector from builder-driven to buyer-protected. The next frontier is digitisation of land records and property registration, which will reduce title disputes and unlock trillions in latent economic value.',
      ],
    },
    future: {
      pullQuote: '"India\'s cities are being built right now. The decisions made in the next 10 years — about density, sustainability, affordability — will determine how 800 million people live for the next 100 years."',
      body: [
        'India\'s real estate sector is projected to reach $1 trillion by 2030 — up from $300 billion today. This growth will be driven by residential demand from millennials, commercial office expansion by MNCs, warehousing from e-commerce, and data centres from the digital economy.',
        'Sustainability is the defining challenge. Indian buildings account for 40% of national energy consumption. Green building standards (IGBC, GRIHA) are gaining adoption, but cost premiums remain a barrier for mass-market housing.',
        'The sector\'s biggest structural opportunity is the formalisation of the land market — clear title records, digital registration, and REITs extending to residential — which could unlock ₹50 lakh crore of currently illiquid wealth stored in Indian property.',
      ],
    },
    startups: [
      { name: 'NoBroker', founded: '2014', focus: 'Zero-brokerage property rental and sale platform', note: 'Unicorn. India\'s largest proptech company. 7 million listings.' },
      { name: 'Housing.com (PropTiger)', founded: '2012', focus: 'Online property search and transaction', note: 'REA Group-owned. 5 million monthly visitors.' },
      { name: 'Magicbricks', founded: '2006', focus: 'India\'s oldest online real estate marketplace', note: 'Times Internet-owned. ₹400 Cr revenue.' },
      { name: 'Square Yards', founded: '2013', focus: 'Integrated real estate platform — search to mortgage', note: 'Listed. Operates in India, UAE, Canada.' },
    ],
  },
